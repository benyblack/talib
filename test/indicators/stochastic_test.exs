defmodule TAlib.Tests.StochasticTests do
  use ExUnit.Case
  alias TAlib.Indicators.Stochastic
  ...
  test "calculate Stochastic %K" do
    assert Stochastic.stochastic_k(@prices, 1000) == 0
    assert Float.round(Stochastic.stochastic_k(@prices), 2) == 90.52
